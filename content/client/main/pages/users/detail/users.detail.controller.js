...
(function () {
    ...
    function UsersDetailController(usersService, $log, $state, uiNotificationsService, filesService, $scope, defaultImageUrl) {
        ...
        function $init() {
            vm.supporters = vm.userSupporters
            vm.therapists = vm.userTherapists
            vm.clients = vm.userClients
            vm.therapistSupport = vm.supporters.concat(vm.therapists, vm.clients)
